...
const translations = {
  ar: {
    ...
    campaignEdit: {
      ...
      runsQueryUrl: 'استعلام التشغيلات حسب survey_id',
      runsQueryHelp: 'يعيد كل التشغيلات في هذا المستأجر، قابل للتصفية بـ survey_id و/أو campaign_ids. يستخدم نفس X-API-Key لأي حملة في المستأجر.',
  ...
  en: {
    ...
    campaignEdit: {
      ...
      runsQueryUrl: 'Query runs by survey_id',
      runsQueryHelp: 'Returns every run in this tenant, filterable by survey_id and/or campaign_ids. Uses the same X-API-Key — any campaign in the tenant.',
